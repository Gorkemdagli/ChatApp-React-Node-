...
export default function LoginPage({ onBack, onLogin, onGoToRegister }: LoginPageProps) {
    ...
    return (
        <div className="min-h-[100dvh] bg-white dark:bg-slate-900 flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden transition-colors">
            ...
            <div className="w-full max-w-[440px] z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-500 dark:text-gray-400 font-medium">Blink dünyasına giriş yapın ve sohbete başlayın.</p>
                </div>
